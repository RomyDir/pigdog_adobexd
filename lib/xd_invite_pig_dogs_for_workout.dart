...
import './xd_einladungen.dart';
import './xd_header_box.dart';
import './xd_status_barlight.dart';
import './xd_plan_wokrout_pig_dogs_added.dart';
import 'package:adobe_xd/page_link.dart';
import './xdi_phone1312_pro_max2.dart';
import './xd_pig_dogs.dart';

class XDInvitePigDogsForWorkout extends StatelessWidget {
  XDInvitePigDogsForWorkout({
    Key key,
  }) : super(key: key);
  @override
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                    ...
                    children: <Widget>[
                      Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromPins(
                            Pin(size: 30.0, end: 10.0),
                            Pin(size: 21.1, middle: 0.4932),
                            child: SvgPicture.string(
                              _svg_v89cvy,
                ...
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(size: 50.0, middle: 0.2009),
                  child:
                      // Adobe XD layer: 'Einladungen' (component)
                      XDEinladungen(),
                ),
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.linear,
                  duration: 0.3,
                  pageBuilder: () => XDPlanWokroutPigDogsAdded(),
                ),
              ],
              child: Stack(
                children: <Widget>[
              ...
              children: <Widget>[
                Stack(
                  children: <Widget>[
                    ...
                    Align(
                      alignment: Alignment(-0.601, -0.017),
                      child: SizedBox(
                        width: 11.0,
                        height: 15.0,
                        child: SvgPicture.string(
                    ...
                    Align(
                      alignment: Alignment(0.605, -0.017),
                      child: SizedBox(
                        width: 11.0,
                        height: 15.0,
                        child: SvgPicture.string(
...
const String _svg_ueqf7h =
    '<svg viewBox="17.4 12.7 25.2 25.2" ><path transform="translate(-78.58, -83.29)" d="M 96 108.0794525146484 L 105.1696929931641 112.1138076782227 L 109.6680297851562 121.16552734375 L 121.16552734375 96 L 96 108.0794525146484 Z M 106.3886489868164 111.7677764892578 L 118.6332473754883 98.69743347167969 L 109.6208419799805 118.2714920043945 L 106.3886413574219 111.7677764892578 Z M 118.475959777832 98.54014587402344 L 105.4999847412109 110.8948516845703 L 98.98841094970703 108.0322723388672 L 118.475959777832 98.54014587402344 Z" fill="#0a374d" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_v89cvy =
    '<svg viewBox="372.0 165.2 30.0 21.1" ><path transform="translate(366.47, 157.81)" d="M 35.17884063720703 7.769961357116699 C 34.73244094848633 7.314539909362793 34.00145721435547 7.307212829589844 33.54603576660156 7.753610610961914 L 15.51752853393555 25.78211784362793 L 7.466262817382812 17.7308521270752 C 7.017326831817627 17.29079627990723 6.299027919769287 17.29079627990723 5.850091457366943 17.7308521270752 C 5.394670009613037 18.17711067199707 5.38734245300293 18.90809631347656 5.83359956741333 19.3635139465332 L 14.70125293731689 28.23116874694824 C 14.91747665405273 28.44809532165527 15.21136379241943 28.56987953186035 15.51765441894531 28.5694580078125 C 15.82394599914551 28.56974220275879 16.11769485473633 28.44795417785645 16.33391761779785 28.23116874694824 L 35.17883682250977 9.386251449584961 C 35.61877822875977 8.937328338623047 35.61877822875977 8.218881607055664 35.17884063720703 7.769961357116699 Z" fill="#0a374d" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_e =
