...
import './xd_pig_dogs2.dart';
import './xd_button_small_pressed.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDPigDogs1 extends StatelessWidget {
  XDPigDogs1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(16.0, 133.0, 16.0, 73.0),
            child: Stack(
              children: <Widget>[
                Align(
                  alignment: Alignment.bottomRight,
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 87.0, end: 87.0),
                  child:
                      // Adobe XD layer: 'Button small not pr…' (component)
                      XDButtonSmallNotPressed(),
                ),
                Align(
                  alignment: Alignment(-1.0, 0.32),
                  child: SizedBox(
                    width: 302.0,
                    height: 108.0,
                    child:
                ...
                Pinned.fromPins(
                  Pin(size: 259.0, start: 16.0),
                  Pin(size: 40.0, middle: 0.1985),
                  child: Text.rich(
                    TextSpan(
                      style: TextStyle(
                        fontFamily: 'Interstate',
                ...
                Pinned.fromPins(
                  Pin(size: 82.0, start: 16.0),
                  Pin(size: 20.0, start: 113.0),
                  child: Text(
                    'CIndy Hirschi',
                    style: TextStyle(
                      fontFamily: 'Interstate',
                ...
                Align(
                  alignment: Alignment(-0.036, -0.44),
                  child: SizedBox(
                    width: 58.0,
                    height: 20.0,
                    child: Text(
                ...
                Pinned.fromPins(
                  Pin(size: 235.0, start: 16.0),
                  Pin(size: 40.0, middle: 0.5132),
                  child: Text(
                    'At vero eos et accusam et justo duo \ndolores et ea rebum.',
                    style: TextStyle(
                      fontFamily: 'Interstate',
