...
import './xd_plan_wokrout_pig_dogs_added2.dart';
...
class XDPlanWokroutPigDogsAdded1 extends StatelessWidget {
  XDPlanWokroutPigDogsAdded1({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Align(
            alignment: Alignment(0.614, -0.558),
            child: SizedBox(
              width: 77.0,
              height: 48.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.575, -0.148),
            child: SizedBox(
              width: 52.0,
              height: 48.0,
              child:
          ...
          Align(
            alignment: Alignment(0.575, -0.353),
            child: SizedBox(
              width: 52.0,
              height: 48.0,
              child:
              ...
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ...
                    ease: Curves.easeOut,
                    duration: 0.3,
                    pageBuilder: () => XDPlanWokroutPigDogsAdded2(),
                  ),
                ],
                child: Stack(
                  children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.512, -0.633),
            child: SizedBox(
              width: 39.0,
              height: 27.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 112.0, start: 61.0),
            Pin(size: 27.0, middle: 0.2836),
            child: Text(
              'Starting Time',
              style: TextStyle(
                fontFamily: 'Interstate',
          ...
          Align(
            alignment: Alignment(-0.566, -0.232),
            child: SizedBox(
              width: 73.0,
              height: 27.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 200.0, start: 16.0),
            Pin(size: 50.0, middle: 0.4247),
            child:
                // Adobe XD layer: 'Button small pressed' (component)
                XDButtonSmallPressed(),
          ),
          Align(
            alignment: Alignment(-0.569, -0.545),
            child: SizedBox(
              width: 71.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.487, -0.148),
            child: SizedBox(
              width: 19.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.617, -0.633),
            child: SizedBox(
              width: 78.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.59, -0.433),
            child: SizedBox(
              width: 62.0,
              height: 27.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(start: 16.0, end: 15.5),
            Pin(size: 184.0, middle: 0.7844),
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Padding(
                      padding: EdgeInsets.fromLTRB(20.0, 0.0, -1179.5, 0.0),
                      child: Stack(
                        children: <Widget>[
                          Pinned.fromPins(
                            Pin(size: 772.0, start: 0.0),
                            Pin(start: 0.0, end: 0.0),
                            child: Stack(
                              children: <Widget>[
                                Pinned.fromPins(
                                ...
                                Pinned.fromPins(
                                  Pin(size: 70.0, start: 57.0),
                                  Pin(size: 27.0, start: 4.0),
                                  child: Text(
                                    'Push Up',
                                    style: TextStyle(
                                      fontFamily: 'Interstate',
                                ...
                                Pinned.fromPins(
                                  Pin(size: 12.2, middle: 0.1968),
                                  Pin(size: 12.7, end: 14.5),
                                  child: Stack(
                                    children: <Widget>[
                                      Pinned.fromPins(
                                        Pin(size: 1.0, middle: 0.5586),
                          ...
                          Pinned.fromPins(
                            Pin(size: 772.0, end: 0.0),
                            Pin(start: 0.0, end: 0.0),
                            child: Stack(
                              children: <Widget>[
                                Pinned.fromPins(
                                  Pin(size: 380.0, start: 0.0),
                                  Pin(start: 0.0, end: 0.0),
                                  child: Stack(
                                    children: <Widget>[
                                      Pinned.fromPins(
          ...
          Align(
            alignment: Alignment(0.617, -0.232),
            child: SizedBox(
              width: 78.0,
              height: 27.0,
              child: Text(
...
const String _svg_mn1xw9 =
    '<svg viewBox="55.0 834.0 107.0 107.0" ><path transform="translate(55.0, 834.0)" d="M 0 0 L 107 0 L 107 107 L 0 107 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_sz7xph =
    '<svg viewBox="2545.0 1234.0 107.0 107.0" ><path transform="translate(2545.0, 1234.0)" d="M 0 0 L 107 0 L 107 107 L 0 107 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_hbcef6 =
    '<svg viewBox="207.5 382.0 4.0 4.0" ><path transform="translate(207.5, 382.0)" d="M 2 0 C 3.104569435119629 0 4 0.8954304456710815 4 2 C 4 3.104569435119629 3.104569435119629 4 2 4 C 0.8954304456710815 4 0 3.104569435119629 0 2 C 0 0.8954304456710815 0.8954304456710815 0 2 0 Z" fill="#a9b6c9" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_q3h3gi =
    '<svg viewBox="217.5 382.0 4.0 4.0" ><path transform="translate(217.5, 382.0)" d="M 2 0 C 3.104569435119629 0 4 0.8954304456710815 4 2 C 4 3.104569435119629 3.104569435119629 4 2 4 C 0.8954304456710815 4 0 3.104569435119629 0 2 C 0 0.8954304456710815 0.8954304456710815 0 2 0 Z" fill="#a9b6c9" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
