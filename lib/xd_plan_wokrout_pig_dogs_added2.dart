...
class XDPlanWokroutPigDogsAdded2 extends StatelessWidget {
  XDPlanWokroutPigDogsAdded2({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Align(
            alignment: Alignment(-0.003, 0.326),
            child: SizedBox(
              width: 209.0,
              height: 48.0,
              child: Stack(
