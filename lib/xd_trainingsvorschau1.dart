...
import './xdi_phone1312_pro_max7.dart';
...
class XDTrainingsvorschau1 extends StatelessWidget {
  XDTrainingsvorschau1({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(size: 274.6, start: 24.0),
            Pin(size: 48.0, middle: 0.167),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 52.4, middle: 0.2357),
          ...
          Align(
            alignment: Alignment(-0.547, -0.546),
            child: SizedBox(
              width: 70.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.557, -0.546),
            child: SizedBox(
              width: 76.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.485, -0.272),
            child: SizedBox(
              width: 24.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.483, 0.101),
            child: SizedBox(
              width: 22.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(0.533, -0.17),
            child: SizedBox(
              width: 60.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.573, 0.19),
            child: SizedBox(
              width: 86.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.56, 0.566),
            child: SizedBox(
              width: 78.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.485, 0.459),
            child: SizedBox(
              width: 24.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.49, 0.459),
            child: SizedBox(
              width: 28.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(0.49, -0.272),
            child: SizedBox(
              width: 28.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(-0.165, -0.274),
            child: SizedBox(
              width: 12.0,
              height: 13.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.165, 0.456),
            child: SizedBox(
              width: 12.0,
              height: 13.0,
              child: Stack(
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(8.0, 18.0, 20.0, 1080.0),
            child:
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.linear,
                  duration: 0.3,
                  pageBuilder: () => XDIPhone1312ProMax7(),
                ),
              ],
              child: Stack(
                children: <Widget>[
...
const String _svg_fy2mr =
    '<svg viewBox="63.0 485.0 107.0 107.0" ><path transform="translate(63.0, 485.0)" d="M 0 0 L 107 0 L 107 107 L 0 107 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_mg9yoj =
    '<svg viewBox="63.0 885.0 107.0 107.0" ><path transform="translate(63.0, 885.0)" d="M 0 0 L 107 0 L 107 107 L 0 107 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
