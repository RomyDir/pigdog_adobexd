...
import './xd_trainingsvorschau.dart';
import './xd_header_box.dart';
import './xd_status_barlight.dart';
import './xdi_phone1312_pro_max4.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDTrainingsvorschau4 extends StatelessWidget {
  XDTrainingsvorschau4({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.485, -0.054),
            child: SizedBox(
              width: 24.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.533, 0.016),
            child: SizedBox(
              width: 60.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.483, 0.228),
            child: SizedBox(
              width: 22.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(-0.58, 0.016),
            child: SizedBox(
              width: 90.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.573, 0.299),
            child: SizedBox(
              width: 86.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.547, -0.267),
            child: SizedBox(
              width: 70.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.485, 0.228),
            child: SizedBox(
              width: 24.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.483, 0.51),
            child: SizedBox(
              width: 22.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(0.557, -0.267),
            child: SizedBox(
              width: 76.0,
              height: 27.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.49, -0.054),
            child: SizedBox(
              width: 28.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(-0.165, 0.508),
            child: SizedBox(
              width: 12.0,
              height: 10.0,
              child: Stack(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Container(
                  ...
                  margin: EdgeInsets.fromLTRB(39.0, 39.0, 38.0, 38.0),
                ),
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  Pin(size: 12.2, end: 22.3),
                  Pin(size: 0.2, end: 11.5),
                  child: Stack(
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, -0.8),
          ...
          Align(
            alignment: Alignment(-0.165, -0.056),
            child: SizedBox(
              width: 12.0,
              height: 13.0,
              child: Stack(
          ...
          Pinned.fromPins(
            Pin(size: 12.2, end: 46.3),
            Pin(size: 12.7, middle: 0.4719),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 1.0, middle: 0.5586),
          ...
          Align(
            alignment: Alignment(-0.165, 0.227),
            child: SizedBox(
              width: 12.0,
              height: 13.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.519, -0.582),
            child:
          ...
          Align(
            alignment: Alignment(0.547, -0.405),
            child: SizedBox(
              width: 12.0,
              height: 13.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.555, -0.405),
            child: SizedBox(
              width: 12.0,
              height: 13.0,
              child: Stack(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDTrainingsvorschau(),
                ),
              ],
              child: Stack(
                children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                XDHeaderBox(),
                Padding(
                  padding: EdgeInsets.fromLTRB(8.0, 18.0, 20.0, 110.0),
                  child:
                  ...
                  child: PageLink(
                    links: [
                      PageLinkInfo(
                        ...
                        ease: Curves.linear,
                        duration: 0.3,
                        pageBuilder: () => XDIPhone1312ProMax4(),
                      ),
                    ],
                    child: Stack(
                      children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 79.0, middle: 0.49),
            Pin(size: 27.0, start: 175.0),
            child: Text(
              'Leg Raise',
              style: TextStyle(
                fontFamily: 'Interstate',
...
const String _svg_pcd77 =
    '<svg viewBox="63.0 933.0 107.0 107.0" ><path transform="translate(63.0, 933.0)" d="M 0 0 L 107 0 L 107 107 L 0 107 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_tnkkpa =
    '<svg viewBox="153.5 331.5 1.0 7.0" ><path transform="translate(153.5, 331.5)" d="M 0 0 L 0 7" fill="none" stroke="#0a374d" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_hr3yz =
    '<svg viewBox="147.2 341.0 12.2 1.0" ><path transform="translate(147.23, 341.0)" d="M 12.228271484375 0.179443359375 L 0 0" fill="none" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_dqn =
    '<svg viewBox="149.5 334.5 1.0 4.0" ><path transform="translate(149.5, 334.5)" d="M 0 0 L 0 4" fill="none" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
...
const String _svg_y0tp89 =
    '<svg viewBox="323.8 419.0 1.0 7.0" ><path transform="translate(323.77, 419.0)" d="M 0 0 L 0 7" fill="none" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_u33h0y =
    '<svg viewBox="317.5 428.5 12.2 1.0" ><path transform="translate(317.5, 428.5)" d="M 12.228271484375 0.179443359375 L 0 0" fill="none" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_vm4x9q =
    '<svg viewBox="327.8 416.0 1.0 10.0" ><path transform="translate(327.77, 416.0)" d="M 0 0 L 0 10" fill="none" stroke="#0a374d" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_nhplmn =
    '<svg viewBox="319.8 422.0 1.0 4.0" ><path transform="translate(319.77, 422.0)" d="M 0 0 L 0 4" fill="none" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_t7snqr =
    '<svg viewBox="102.8 418.8 1.0 7.0" ><path transform="translate(102.77, 418.82)" d="M 0 0 L 0 7" fill="none" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_z8sh4 =
    '<svg viewBox="96.5 428.3 12.2 1.0" ><path transform="translate(96.5, 428.32)" d="M 12.228271484375 0.179443359375 L 0 0" fill="none" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_wined =
    '<svg viewBox="106.8 415.8 1.0 10.0" ><path transform="translate(106.77, 415.82)" d="M 0 0 L 0 10" fill="none" stroke="#a9b6c9" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_pmrw5i =
    '<svg viewBox="98.8 421.8 1.0 4.0" ><path transform="translate(98.77, 421.82)" d="M 0 0 L 0 4" fill="none" stroke="#0a374d" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
