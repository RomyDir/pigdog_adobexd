...
import './xd_trainingsvorschau6.dart';
...
class XDTrainingsvorschau5 extends StatelessWidget {
  XDTrainingsvorschau5({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(24.0, 135.0, 24.0, 19.0),
            child: Stack(
              children: <Widget>[
                Align(
                ...
                Align(
                  alignment: Alignment(-0.242, 0.457),
                  child: SizedBox(
                    width: 37.0,
                    height: 20.0,
                    child: Text(
                  ...
                  child:
                    ...
                    links: [
                      PageLinkInfo(
                        ...
                        ease: Curves.linear,
                        duration: 0.3,
                        pageBuilder: () => XDTrainingsvorschau6(),
                      ),
                    ],
                    child: Container(
                      width: 184.0,
                ...
                Align(
                  alignment: Alignment(-0.238, -0.064),
                  child: SizedBox(
                    width: 36.0,
                    height: 20.0,
                    child: Text(
...
const String _svg_cuhskt =
    '<svg viewBox="63.0 370.0 107.0 107.0" ><path transform="translate(63.0, 370.0)" d="M 0 0 L 107 0 L 107 107 L 0 107 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_u3gz =
    '<svg viewBox="63.0 770.0 107.0 107.0" ><path transform="translate(63.0, 770.0)" d="M 0 0 L 107 0 L 107 107 L 0 107 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_e =
