    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.501, -0.018),
            child: SizedBox(
              width: 87.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.588, -0.018),
            child: SizedBox(
              width: 15.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.317, 0.545),
            child: SizedBox(
              width: 179.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(0.577, 0.545),
            child: SizedBox(
              width: 26.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.388, 0.638),
            child: SizedBox(
              width: 150.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.56, 0.638),
            child: SizedBox(
              width: 42.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.397, 0.731),
            child: SizedBox(
              width: 146.0,
              height: 20.0,
              child: Text(
                'Longest Workout Break',
                style: TextStyle(
                  fontFamily: 'Interstate',
                  fontSize: 15,
                  color: const Color(0xff0a374d),
          ...
          Align(
            alignment: Alignment(0.554, 0.731),
            child: SizedBox(
              width: 47.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.428, 0.453),
            child: SizedBox(
              width: 131.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(0.595, 0.453),
            child: SizedBox(
              width: 8.0,
              height: 20.0,
              child: Text(
...
const String _svg_j4b082 =
    '<svg viewBox="85.5 732.0 258.0 1.0" ><path transform="translate(85.5, 732.0)" d="M 0 0 L 258 0" fill="none" stroke="#0a374d" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ll2yua =
    '<svg viewBox="85.5 776.0 258.0 1.0" ><path transform="translate(85.5, 776.0)" d="M 0 0 L 258 0" fill="none" stroke="#0a374d" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_i2ji =
    '<svg viewBox="85.5 690.0 258.0 1.0" ><path transform="translate(85.5, 690.0)" d="M 0 0 L 258 0" fill="none" stroke="#0a374d" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
