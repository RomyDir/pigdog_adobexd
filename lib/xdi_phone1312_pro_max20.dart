...
import './xdi_phone1312_pro_max21.dart';
import './xdi_phone1312_pro_max12.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDIPhone1312ProMax20 extends StatelessWidget {
  XDIPhone1312ProMax20({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Padding(
                      padding: EdgeInsets.fromLTRB(42.5, 0.0, -144.5, 0.0),
                      child: Stack(
                        children: <Widget>[
                          Pinned.fromPins(
                            ...
                            child:
                              ...
                              links: [
                                PageLinkInfo(
                                  ...
                                  ease: Curves.easeOut,
                                  duration: 0.3,
                                  pageBuilder: () => XDIPhone1312ProMax21(),
                                ),
                              ],
                              child: XDButtonSmallNotPressed(),
                            ),
...
const String _svg_dc1xni =
    '<svg viewBox="85.5 730.0 258.0 1.0" ><path transform="translate(85.5, 730.0)" d="M 0 0 L 258 0" fill="none" stroke="#0a374d" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_cw5eq =
    '<svg viewBox="85.5 686.0 258.0 1.0" ><path transform="translate(85.5, 686.0)" d="M 0 0 L 258 0" fill="none" stroke="#0a374d" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
