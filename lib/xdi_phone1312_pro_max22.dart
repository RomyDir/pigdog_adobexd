...
import './xdi_phone1312_pro_max23.dart';
import './xdi_phone1312_pro_max12.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDIPhone1312ProMax22 extends StatelessWidget {
  XDIPhone1312ProMax22({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDIPhone1312ProMax23(),
                ),
              ],
              child: Container(
                color: const Color(0xfff9fafb),
          ...
          Align(
            alignment: Alignment(-0.544, 0.208),
            child: SizedBox(
              width: 55.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.564, 0.393),
            child: SizedBox(
              width: 38.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.506, 0.486),
            child: SizedBox(
              width: 84.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(0.577, 0.486),
            child: SizedBox(
              width: 26.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.557, 0.578),
            child: SizedBox(
              width: 44.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.577, 0.578),
            child: SizedBox(
              width: 26.0,
              height: 20.0,
              child: Text(
