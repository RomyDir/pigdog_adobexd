...
class XDIPhone1312ProMax9 extends StatelessWidget {
  XDIPhone1312ProMax9({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.388, 0.26),
            child: SizedBox(
              width: 150.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(0.577, 0.26),
            child: SizedBox(
              width: 26.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.472, 0.757),
            child: SizedBox(
              width: 107.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.583, 0.757),
            child: SizedBox(
              width: 19.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.467, 0.85),
            child: SizedBox(
              width: 110.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.585, 0.85),
            child: SizedBox(
              width: 17.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.403, 0.137),
            child: SizedBox(
              width: 144.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.583, 0.137),
            child: SizedBox(
              width: 19.0,
              height: 20.0,
              child: Text(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    Pin(size: 35.9, middle: 0.3449),
                    Pin(size: 36.1, end: 6.9),
                    child: Stack(
                      children: <Widget>[
                        Padding(
                          padding: EdgeInsets.all(4.9),
          ...
          Align(
            alignment: Alignment(-0.536, -0.049),
            child: SizedBox(
              width: 63.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.555, -0.049),
            child: SizedBox(
              width: 45.0,
              height: 20.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.423, 0.044),
            child: SizedBox(
              width: 134.0,
              height: 20.0,
              child: Text.rich(
          ...
          Align(
            alignment: Alignment(0.567, 0.044),
            child: SizedBox(
              width: 34.0,
              height: 20.0,
              child: Text(
...
const String _svg_knghg =
    '<svg viewBox="85.3 830.0 258.0 1.0" ><path transform="translate(85.25, 830.0)" d="M 0 0 L 258 0" fill="none" stroke="#0a374d" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_j7wblq =
    '<svg viewBox="85.3 505.0 258.0 1.0" ><path transform="translate(85.25, 505.0)" d="M 0 0 L 258 0" fill="none" stroke="#0a374d" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
